...
enum PlayerExpandedMetrics {
    static let defaultOuterSpacing: CGFloat = 6
    static let defaultPrimaryColumnSpacing: CGFloat = 10
    static let defaultTitleBlockSpacing: CGFloat = 3
    static let defaultControlsSpacing: CGFloat = 5
    static let defaultArtworkCornerRadius: CGFloat = 8
    static let defaultArtworkSize: CGFloat = 40
    static let defaultProgressSectionSpacing: CGFloat = 3
